...
function getAttributesFromElems() {
    ...
    attributesAndFrames.attributes = getAttributesOfElemAndAncestors(window.lastSelectedElem);
...
export let injectString = "var lastSelectedElem = $0; var myInspect = inspect; ";
